...
Changing projects is not typical for Java engineers, so let me share details about my "unique" experience:

|     Left      |     Company     | Client  |         Project         | Leaving Reason                                                                                                                                                                                                                                                                                                                                        |
|:-------------:|:---------------:|---------|:-----------------------:|:------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| May&nbsp;2025 |   GlobalLogic   | Japan   |   **Java&nbsp;Tools**   | Driven by Customer. It was the end of the contract and the Client had no more work to do. The specifics of development were short-term assignments, which our team successfully completed working on 3 different sub-projects. Based on applications that require no more support, the major part of GlobalLogic employees were released to the pool. |
| Oct&nbsp;2024 |   GlobalLogic   | USA     | **Enterprise&nbsp;Web** | Driven by Customer. It was the end of the contract and the Client decided to suspend active product development. A large amount of work was successfully completed and almost all of GlobalLogic employees finished working on the project.                                                                                                           |
| Oct&nbsp;2023 | EPAM<br>Systems | USA     | **Enterprise&nbsp;Web** | Driven by Customer. As part of *Cost Saving* program, all EPAM employees were ramped down in several waves. As stated by the Customer Top Management, there were internal processes that are not related to EPAM performance. In fact, Customer Middle Management appreciated our contribution and it was a big loss for them.                        |
| Sep&nbsp;2021 | EPAM<br>Systems | GB      | **Cloud&nbsp;Pipeline** | Driven by Customer. Our team successfully finished active phase of development by releasing stable version of app. Finally, we organized knowledge transfer and passed app to support team.                                                                                                                                                           |
| Dec&nbsp;2020 | EPAM<br>Systems | USA     |   **Java&nbsp;Tool**    | Driven by Customer. It was short project with fixed term assignment. Our team successfully implemented the pilot version of the application, and it was sufficient for the Customers at that moment.                                                                                                                                                  |
| Sep&nbsp;2020 |   RINANU&ast;   | Ukraine |  **Java&nbsp;Desktop**  | Driven by me. I worked at a government department and wanted to switch to an IT company. Leaving this project, I left successfully implemented beta version of app and did comprehensive knowledge transfer.                                                                                                                                          |
